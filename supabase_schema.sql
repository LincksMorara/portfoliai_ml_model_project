-- ================================================
-- PortfoliAI Supabase Database Schema
-- ================================================
...
CREATE TABLE public.investor_profiles (
  ...
  -- Core ML-generated profile data
  ...
  -- Survey data (complete survey responses from frontend)
...
-- ================================================
-- Next steps:
-- 1. Copy your Supabase project URL and keys to .env
-- 2. Enable email verification in Supabase Auth settings
-- 3. Run the Python app with the new structure
-- ================================================
